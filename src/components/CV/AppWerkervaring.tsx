...
export default () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="grid grid-cols-1 grid-rows-mobile text-white h-full tablet:h-4/5">
      <h2 className="mb-8 justify-self-center self-end font-heading text-3xl font-medium tablet:text-4xl">
        Werkervaring
      </h2>
      <div className="flex flex-row">
        <button className="mt-2 mr-2 h-fit" onClick={() => showingInfo(1)}>
        ...
        <div className="flex flex-col items-start">
          ...
          <div className={`flex-col items-start ${showInfo === 1 || isTablet ? 'flex' : 'hidden'} `}>
      ...
      <div className="flex flex-row">
        <button className="mt-2 mr-2 h-fit" onClick={() => showingInfo(2)}>
      ...
      <div className="flex flex-row">
        <button className="mt-2 mr-2 h-fit" onClick={() => showingInfo(3)}>
        ...
        <p className="mb-4 font-body font-light">
          ...
          <div className={`flex-col items-start ${showInfo === 3 || isTablet ? 'flex' : 'hidden'}`}>
          <p className="font-body">
      ...
      <div className="flex flex-row">
        <button className="mt-2 mr-2 h-fit" onClick={() => showingInfo(4)}>
