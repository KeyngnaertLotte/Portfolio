...
export default () => {
  return (
    ...
    //     </div>
    // </div>
    <div className="text-white grid grid-cols-1 h-full mt-10 ">
      <h2 className="font-heading text-3xl font-medium justify-self-center">Opleiding</h2>
        <div className='row-start-2 text-right justify-items-end my-3'>
            <h3 className="font-heading text-2xl font-medium">Multimedia Visueel</h3>
            <p className="font-light font-body mb-4">Afgestudeerd in 2020</p>
        ...
        <img title='Afbeelding gemaakt op Athena Campus Heule' src={athenaHeule} alt="Foto op Athena campus Heule By me" className='w-1/2 rounded-lg justify-self-center shadow-md shadow-accent '/>
        <div className='row-start-3 my-3'>
            <h3 className="font-heading font-medium text-2xl">Multimedia & Creative Technologie</h3>
            <p className="font-light font-body mb-4">2020 - heden</p>
            <a href="https://mct.be/" target="_blank" rel="noreferrer" className='flex flex-row gap-2 font-body italic'><Link className='stroke-white w-4'/> Howest in Kortrijk</a>
        </div>
    </div>
  )
}
