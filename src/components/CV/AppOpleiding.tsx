...
export default () => {
  return (
    // <div className="  my-8 h-full w-11/12 gap-y-6 gap-x-24 items-center content-center">
    ...
    <div className="text-white grid grid-cols-1 h-full mt-10 tablet:grid-cols-2 tablet:grid-rows-tablet tablet:h-4/5 items-center web:h-full web:w-11/12 web:gap-8 web:grid-rows-web">
      <h2 className="font-heading text-3xl font-medium justify-self-center tablet:col-span-2">Opleiding</h2>
        ...
        <img title='Afbeelding gemaakt op Athena Campus Heule' src={athenaHeule} alt="Foto op Athena campus Heule By me" className='w-1/2 mb-6 rounded-lg justify-self-center shadow-md shadow-accent tablet:row-span-2 tablet:col-start-2 tablet:self-center tablet:w-3/5 tablet:mb-0 web:w-1/2 web:row-start-2 web:m-4 web:justify-self-start'/>
