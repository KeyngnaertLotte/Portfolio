    ...
    <div className="text-white grid grid-cols-1 h-full mt-10 tablet:grid-cols-2 tablet:grid-rows-tablet tablet:h-4/5  items-center web:h-full web:w-11/12 web:gap-8 web:grid-rows-web">
      <h2 className="font-heading text-3xl font-medium justify-self-center tablet:col-span-2 tablet:text-4xl">Opleiding</h2>
        <div className='row-start-2 text-right my-3 tablet:my-1'>
            ...
            <a href="https://www.athena-school.be/onze-school/campus-heule" target="_blank" rel="noreferrer" className='flex flex-row gap-2 justify-end font-body italic focus:text-accent focus:outline-none hover:text-accent'><Link className='stroke-white w-4 focus:stroke-accent '/> Athena in Heule</a>
        </div>
        ...
        <div className='row-start-3 my-3 tablet:text-right tablet:my-1'>
            ...
            <a href="https://mct.be/" target="_blank" rel="noreferrer" className='flex flex-row gap-2 font-body italic tablet:justify-end focus:text-accent focus:outline-none hover:text-accent'><Link className='stroke-white w-4'/> Howest in Kortrijk</a>
        </div>
    </div>
  )
}
