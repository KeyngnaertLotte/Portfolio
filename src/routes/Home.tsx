...
export default function Home() {
  ...
  return (
    // <main className="bg-black h-screen flex flex-col-reverse web:flex-row">
    ...
    <main className="h-screen w-screen flex flex-col-reverse">
      <div className='h-2/3 w-full '> <img src={bg} alt="" className='h-full'/></div>
      <div className="h-1/3 w-full flex flex-row justify-between p-4">
        <h1 className='text-white font-heading font-bold text-5xl self-center'>Lotte Keyngnaert</h1>
        {/* <AppNavigation /> */}
        <button className='self-start' onClick={showNavigation}><Menu className='stroke-white' size={60}/></button>
      </div>
